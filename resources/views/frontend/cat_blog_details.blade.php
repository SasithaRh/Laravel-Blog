            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="breadcrumb__wrap__content">
                        <h2 class="title">{{ $cat['blog_category']}}</h2>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="standard__blog__post">
                        <div class="standard__blog__thumb">
                            <a href="blog-details.html"><img src="{{ asset('upload/blog_image/')}}/{{ $allBlog['blog_image']}}" alt=""></a>
                        ...
                        <div class="standard__blog__content">
                            ...
                            <p><p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which dont look even slightly believable</p></p>
                            ...
                            <ul class="rc__post">
                                ...
                                <li class="rc__post__item">
                                    <div class="rc__post__thumb">
                                        <a href="{{ route('blog-details', $allBlog['id']) }}"><img src="{{ asset('upload/blog_image/')}}/{{ $allBlog['blog_image']}}" alt=""></a>
                                    </div>
