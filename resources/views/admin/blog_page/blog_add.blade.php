                    ...
                    <div class="card-body">
                       ...
                       <form action="{{ route('store.blog') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="blog_category_id" aria-label="Default select example">
                                    ...
                                    <option value="{{$categorie['id']  }}">{{ $categorie['blog_category'] }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" value="home,tech" name="blog_tags" id="example-text-input" data-role="tagsinput">
                            </div>
